            ...
            {finalQuiz && (
              <div className="bg-surface-container-lowest p-6 border border-surface-dim/20 rounded-3xl shadow-lg flex justify-between items-start">
                <div>
                  ...
                  <p className="text-xs font-bold text-emerald-500 uppercase tracking-widest bg-emerald-500/10 px-2 py-1 rounded-md inline-block">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="p-2 text-blue-600 bg-blue-500/10 rounded-lg hover:bg-blue-500/20 text-xs font-bold px-3"
                  >
                    Questions ({finalQuiz.questions?.length || 0})
                  </button>
                  <button
                    onClick={() => openModal("quiz", finalQuiz, null, "final")}
                ...
                >
                  ...
                  {activeModal === "quiz" && (
                    <>
                      <div className="mb-4">
                        <span
                          className={`text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-md ${quizForm.type === "final" ? "bg-emerald-500/10 text-emerald-600" : "bg-blue-500/10 text-blue-600"}`}
                        >
                          {quizForm.type} Quiz
                        </span>
                      </div>
                    ...
                    {editingItem?.questions?.map((q, idx) => (
                      ...
                      >
                        <button
                          ...
                          className="absolute top-2 right-2 p-1 text-red-500/50 hover:text-red-500 opacity-0 group-hover:opacity-100 transition-opacity"
                        >
                          <Trash2 className="w-4 h-4" />
                        </button>
                        ...
                        <ul className="mt-2 space-y-1 pl-4">
                          {(() => {
                            ...
                            return (
                              <li
                                key={oIdx}
                                className={`text-xs ${isCorrect ? "text-emerald-600 font-bold" : "text-secondary"}`}
                              >
                                {oIdx === 0
                                  ? "A"
                                  : oIdx === 1
