    ...
    <div className="min-h-screen bg-surface">
      ...
      <div className="signature-gradient py-12 sm:py-16 md:py-20 mb-8 px-4 sm:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            Explore our curated collection of premium courses designed by
            industry experts.
          </motion.p>
          <motion.div
            initial={{ scaleX: 0 }}
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
          <div>
            <p className="text-on-surface-variant text-sm font-medium">
              ...
              courses
              {hasActiveFilters && (
                <span className="text-xs ml-2 text-primary/60 font-bold bg-primary/5 px-2 py-0.5 rounded-full">
                  FILTERED
                </span>
              )}
            </p>
